...
const ItemList = () => {
    ...
    useEffect(() => {
        dispatch(fetchItems({curVariants, brand, type, category, page, limit: 15}))
    ...
    return (
        <>
            <div className={classes['ItemList']} ref={firstInView}>
                {items.rows.map(i =>
                    <div className={classes['ItemList__item']} key={i.id}
                    ...
                    >
                        ...
                        <div className={classes['ItemList__item-image']}
